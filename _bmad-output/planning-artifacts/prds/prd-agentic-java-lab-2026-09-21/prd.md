...
9. **Escopo de implementação da V1.** A §6 diz que a V1 cobre FR-1 a FR-18, mas só uma story é medida. Decidir se as demais FRs da API (FR-13 a FR-17) são implementadas na V1, sem medição, ou apenas especificadas. *Responsável: backlog e arquitetura, antes da implementação.*
